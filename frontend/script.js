...
function sendMessageToServer(message) {
    ...
    .then(data => {
        ...
        if (Array.isArray(data) && data.length > 0) {
            ...
            addMessageWithTypewriterEffect("bot", "Sorry, I encountered an error: " + data.error);
        } else {
    ...
    .catch((error) => {
        ...
        removeTypingIndicator();
        addMessageWithTypewriterEffect("bot", "Sorry, I had trouble understanding that. Please try again.");
    });
}
